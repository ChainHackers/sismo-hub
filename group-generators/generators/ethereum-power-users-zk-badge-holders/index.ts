...
const generator: GroupGenerator = {
  ...
  generate: async (context: GenerationContext): Promise<GroupWithData[]> => {
    ...
    const getEthereumPowerUsersZkBadgeHolders = await bigQueryProvider.getBadges<DonateEventType>({
            contractAddress: contractAddress,
            eventABI: donateEventABI,
            options: {
                zk_badge_id: "10000005",
                zk_badge_value: "1"
            }
          });
    ...
    return [
      {
        name: "ethereum-power-users-zk-badge-holders",
